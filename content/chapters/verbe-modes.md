...
Après une subordonnée introduite par **que**, quand la principale exprime volonté, sentiment, doute ou nécessité — jamais un fait certain.

| | |
|---|---|
| volonté | je veux **que** tu vien**nes** |
| sentiment | je suis content **que** tu **sois** là |
...
| | parler | être | avoir |
|---|---|---|---|
| je | parler**ais** | ser**ais** | aur**ais** |
| tu | parler**ais** | ser**ais** | aur**ais** |
| il / elle | parler**ait** | ser**ait** | aur**ait** |
| nous | parler**ions** | ser**ions** | aur**ions** |
...
| Condition | *si* + | Principale |
|---|---|---|
| réelle | présent | futur simple ou présent |
