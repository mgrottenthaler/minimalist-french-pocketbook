...
**ne** devant le verbe, **pas** après — et après l'auxiliaire, pas le participe, aux temps composés.
...
Trois façons de poser une question totale, du plus informel au plus soutenu.
...
| | |
|---|---|
| élément détaché en tête | **Paul**, je **le** connais bien. |
| élément détaché en fin | Je **le** connais bien, **Paul**. |
| **c'est... qui / que** | **C'est Paul qui** a téléphoné. **C'est ça que** je veux. |
...
| Subordination | |
|---|---|
| complétives | **que** (fait), **si** (question indirecte) |
| causales | parce que, puisque, comme |
| finales | pour que, afin que |
| concessives | bien que, quoique, même si |
| consécutives | si bien que, de sorte que |
